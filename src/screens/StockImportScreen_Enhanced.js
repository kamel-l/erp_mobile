...
export default function StockImportScreen({ navigation }) {
    ...
    const parseAndImportCSV = async (csvContent) => {
        try {
            ...
            Alert.alert(
                'Import réussi',
                `${productsList.length} produit(s) importé(s) avec succès`
            );
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <Card style={{ marginTop: 20, backgroundColor: '#E3F2FD' }}>
                ...
                <Text style={styles.infoText}>
                    name,price,stock_quantity,min_stock,category,barcode,description
                </Text>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <TextInput
                            ...
                            placeholder="name,price,stock_quantity,min_stock,category,barcode&#10;Produit A,1500,10,5,Catégorie,CODE001&#10;Produit B,2500,20,10,Catégorie,CODE002"
                            multiline
                            numberOfLines={10}
                            placeholderTextColor="#BDBDBD"
                        />
